...
struct ThreeDView:View{
    ...
    @State var models = [
        Model(id: 0, name:"Star Ferry", modelName: "ship.usdz",details:"Star Ferry boats have been transporting passengers from Hong Kong Island to Kowloon and back for over a century and offer a unique vantage point on the city’s beautiful harbour."),
